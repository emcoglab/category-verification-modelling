...
def main(spec: CategoryVerificationJobSpec, spec_filename: str, exclude_repeated_items: bool,
    ...
    model_data: Dict[CategoryObjectPair, DataFrame] = load_model_output_from_dir(activation_traces_dir, validation=validation_run, for_participant_dataset=participant_datasets, use_assumed_object_label=use_assumed_object_label)
